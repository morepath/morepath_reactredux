...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"foo.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    addAnimal: (0, _redux.bindActionCreators)(_actions.addAnimal, dispatch),
	    deleteAnimal: (0, _redux.bindActionCreators)(_actions.deleteAnimal, dispatch)
	  };
	}
	
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_components.Animals);
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	var LOAD_ANIMALS = 'LOAD_ANIMALS';
	exports.LOAD_ANIMALS = LOAD_ANIMALS;
	
	function loadAnimals(animalsId) {
	  return function (dispatch) {
	    return fetch(animalsId).then(function (response) {
	...
	function addAnimal(name, species) {
	  return function (dispatch, getState) {
	    var animalsId = getState().animalsId;
	...
	var DELETE_ANIMAL = 'DELETE_ANIMAL';
	exports.DELETE_ANIMAL = DELETE_ANIMAL;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Animal(_ref) {
	  ...
	  var deleteAnimal = _ref.deleteAnimal;
	...
	var Animals = (function (_React$Component) {
	  ...
	  function Animals() {
	    ...
	    _get(Object.getPrototypeOf(Animals.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Animals, [{
	    ...
	    value: function render() {
	      ...
	      var animals = _props.animals;
	      var addAnimal = _props.addAnimal;
	      var deleteAnimal = _props.deleteAnimal;
	
	      var items = animals.map(function (animal) {
	        return _react2['default'].createElement(
	          'li',
	          { key: animal['@id'] },
	          _react2['default'].createElement(Animal, { animal: animal, deleteAnimal: deleteAnimal })
	        );
	      });
	
	      var handleClick = function handleClick() {
	        addAnimal(_this.refs.name.value, _this.refs.species.value);
	      };
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { type: 'text', ref: 'species' }),
	          _react2['default'].createElement(
	            'button',
	            { onClick: handleClick },
	            'Add'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.store = store;
	store.dispatch((0, _actions.loadAnimals)('/api/animals'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function update(state, action) {
	  ...
	  if (action.type === _actions.LOAD_ANIMALS) {
	    return {
	      animals: action.animals,
	      animalsId: action.animalsId
	    };
	  } else if (action.type === _actions.ADD_ANIMAL) {
	    var newAnimals = state.animals.slice();
	    newAnimals.push({
	      '@id': action.animalId,
	      name: action.name,
	  ...
	  } else if (action.type === _actions.DELETE_ANIMAL) {
	    return {
	      animals: action.animals,
