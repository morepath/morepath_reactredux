...
def test_zoo():
    ...
    zoo = {"animals": [
        ...
        {"@id": "http://localhost/animals/2", "name": "Anna", "species": "elephant"},
...
def test_animal():
    ...
    assert response.json == {"@id": "http://localhost/animals/0", "name": "Bob", "species": "snake"}
...
def test_add_animal():
    ...
    new_animal_response = {"@id": "http://localhost/animals/4", "name": "Lupus", "species": "wolf"}
...
def test_change_animal():
    ...
    changed_animal_response = {"@id": "http://localhost/animals/1", "name": "Changed Fred", "species": "fish"}
